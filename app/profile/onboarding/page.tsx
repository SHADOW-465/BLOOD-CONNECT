...
import { User, Droplet, Phone, ArrowRight } from "lucide-react";
...
export default function ProfileOnboardingPage() {
  ...
  const canContinue = name && phone && bloodType && rh;
      ...
      >
        <div className="flex flex-col items-center text-center mb-6">
          <div className="w-16 h-16 rounded-full bg-[#f0f3fa] flex items-center justify-center mb-4 shadow-[inset_8px_8px_16px_#d1d9e6,inset_-8px_-8px_16px_#ffffff]">
            <User className="w-8 h-8 text-[#ff1493]" />
          </div>
        ...
        <div className="mt-6">
          <h2 className="text-lg font-semibold text-gray-700 mb-3 font-mono text-center">
            Blood Group
          </h2>
